    ...
    return (
        <div className='min-h-screen bg-white'>
            <div className='max-w-7xl mx-auto'>
                <div className='relative z-10 pb-8 bg-white sm:pb-16 md:pb-14'>
                    <main className='mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-25'>
                        <div className='text-center'>
                            ...
                            <div className='mt-6 text-base text-indigo-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-10 md:text-xl '>
                                <p className='animate-[breathe_3s_ease-in-out_infinite]'>
                                    {tagLine}
                                </p>
                            </div>
                        </div>
